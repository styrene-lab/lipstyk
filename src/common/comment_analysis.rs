...
pub const INTENT_SIGNALS: &[&str] = &[
    "because", "since", "so that", "ensures", "prevents", "avoids",
    "workaround", "hack", "note", "nb", "important", "careful",
    "assumes", "invariant", "constraint", "must", "should", "otherwise",
    "tradeoff", "trade-off", "perf", "performance", "safety", "reason",
    "why", "intentional", "deliberately", "temporary", "legacy", "upstream",
    "see also", "cf.", "unlike", "not", "don't", "cannot", "can't",
    "won't", "never", "except", "unless", "despite", "although",
    "however", "but",
];
...
pub const GENERIC_TODO_PATTERNS: &[&str] = &[
    "add error handling", "add proper error handling", "handle error",
    "handle errors", "implement this", "implement later", "add logging",
    "add proper logging", "add validation", "validate input",
    "add input validation", "add tests", "write tests", "add unit tests",
    "clean up", "clean this up", "refactor this", "refactor later",
    "optimize this", "optimize later", "improve this", "fix this",
    "fix later", "make this better", "add documentation",
    "add proper documentation", "handle edge cases", "handle edge case",
    "add type checking", "implement properly", "add retry logic",
    "add caching",
];

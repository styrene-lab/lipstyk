...
pub const GENERIC_FUNCTION_NAMES: &[&str] = &[
    "process_data", "process_input", "process",
    "handle_request", "handle_event", "handle",
    "do_work", "do_something",
    "get_data", "get_result", "get_info", "get_value",
    "fetch_data", "load_data", "save_data", "update_data",
    "perform_action", "execute_action", "execute",
    "run_task", "run",
